...
<li>Matricola2: <b><%= studente.getMatricola() %></b></li>
<li>Data di nascita: <b><%= studente.getDataNascita() %></b></li>
</ul>
<hr>
<iframe src="//giphy.com/embed/4LWEwOMfbVeYU?html5=true&hideSocial=true" width="200" height="200" frameBorder="0" class="giphy-embed"></iframe>
